/**
 * markdown 编辑器
 * 调用方法，修改为require调用  调用前，先配置好require.js 模块路径设置
...
define(['marked','css!markdown'], function(marked){
(function (global) {
...
// CodeMirror is the only global var we claim
    ...
    function togglePreview(editor) {
        ...
        if (!/editor-preview/.test(preview.className)) {
            ...
            preview.className = 'editor-preview markdown-body';         //应用markdown.css markdown-body样式
